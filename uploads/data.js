...
const CATEGORIES = [
  ...
  },
  {
    ...
    icone: '🏠',
    elements: [
      { nom: 'Maison', mot: 'house' },
      { nom: 'Immeuble', mot: 'apartment building' },
      { nom: 'École', mot: 'school building' },
      { nom: 'Université', mot: 'university campus' },
      { nom: 'Usine', mot: 'factory' },
      { nom: 'Hôpital', mot: 'hospital building' },
      { nom: 'Église', mot: 'church' },
      { nom: 'Château', mot: 'castle' },
      { nom: 'Gare', mot: 'train station' },
      { nom: 'Aéroport', mot: 'airport terminal' },
      { nom: 'Quai', mot: 'harbour quay' },
      { nom: 'Port', mot: 'harbor port' },
      { nom: 'Phare', mot: 'lighthouse' },
      { nom: 'Pont', mot: 'bridge' },
      { nom: 'Musée', mot: 'museum' },
      { nom: 'Bibliothèque', mot: 'library' },
      { nom: 'Boulangerie', mot: 'bakery shop' },
      { nom: 'Marché', mot: 'street market' },
      { nom: 'Piscine', mot: 'swimming pool' },
      { nom: 'Stade', mot: 'stadium' },
      { nom: 'Ferme', mot: 'farm' },
      { nom: 'Zoo', mot: 'zoo' },
      { nom: 'Village', mot: 'village' },
      { nom: 'Jardin public', mot: 'public park garden' }
    ]
  },
  {
    id: 'animaux',
